...
public:
	...
	int search(T searchKey)
	{
		...
		while (1)	// <-- Replaced with recursion
		{
			...
			{
				// Found the item in the middle of the array. Return index
				return current;
			}
			...
			{
				// Step 3: Check which half of the array value is in
				if (m_array[current] < searchKey)
				{
...
private:
	// Variables
	T* m_array;			// Pointer to the beginning of the arrray
